...
# SECRET_KEY = 'django-insecure-fp1ztub7wxl-4&&#f=iizvozm=d^9r8q4ugtsre=4ejv%qv)x8'
...
ALLOWED_HOSTS = ['*'] # colocar o domínio para segurança em produção
